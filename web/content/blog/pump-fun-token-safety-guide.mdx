...
> **Scan any Pump.fun deployer right now** — Paste a token address into [DaybreakScan](https://www.daybreakscan.com/scan) and instantly check the deployer's rug rate, funding cluster, and risk score. Free to use, no signup required.
