        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <a
              ...
              className="flex items-center gap-2 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 border border-slate-600 hover:border-slate-500 rounded-lg transition-all text-sm group"
            >
              ...
              <span className="text-slate-300 group-hover:text-white transition-colors">Star</span>
              <span className="text-[10px] text-slate-500 bg-slate-700/50 px-1.5 py-0.5 rounded font-mono">0</span>
            </a>
            <a
              href="https://github.com/Jpatching/daybreak/issues/new"
              target="_blank"
              rel="noopener noreferrer"
              className="px-3 py-1.5 text-sm border border-amber-500/50 text-amber-400 hover:bg-amber-500/10 rounded-lg transition-colors"
            >
              Report Bug
            </a>
            <a
